...
class BaseTrainer:
            ...
            for i, batch in pbar:
                ...
                with autocast(self.amp):
                    ...
                    if torch.isnan(self.loss):
                        ...
                        LOGGER.error(
                            f"{BOLD}{RED}请尝试把AMP参数设置False以关闭混合精度训练再进行尝试，还是NAN请更换下一个模块。{RESET}"
                        )
    ...
    def _log_fitness_progress(self):
        ...
        LOGGER.info(
            f"{BOLD}{ORANGE}Fitness: current={current:.5f}, prev_best={prev_best}, delta={delta:+.5f}, best={best}{updated}{RESET}"
        )
