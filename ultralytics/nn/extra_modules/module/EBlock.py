"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2025-EBlock.png
...
class EBlock(nn.Module):
    ...
    def __init__(self, inc, c, DW_Expand=2, dilations=None, extra_depth_wise=False):
...
if __name__ == "__main__":
    ...
    module = EBlock(in_channel, out_channel).to(device)
