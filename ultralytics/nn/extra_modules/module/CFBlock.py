"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/AAAI2024-CFBlock.png
ultralytics/nn/module_images/AAAI2024-CFBlock.md
...
class ConvolutionalAttention(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, inter_channels, num_heads=8):
        super().__init__()
    ...
    def _act_dn(self, x):
        ...
        )  # n,c_inter,h,w -> n,heads,c_inner//heads,hw
        x = F.softmax(x, dim=3)
...
class CFBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, num_heads=8, drop_rate=0.0, drop_path_rate=0.0):
        super().__init__()
        ...
        self.attn_l = ConvolutionalAttention(out_channels_l, out_channels_l, inter_channels=64, num_heads=num_heads)
...
if __name__ == "__main__":
    ...
    module = CFBlock(in_channel, out_channel).to(device)
