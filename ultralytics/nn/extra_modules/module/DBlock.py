"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2025-DBlock.png
论文链接：https://arxiv.org/abs/2412.13443.
"""
...
class Adapter(nn.Module):
    def __init__(self, c, ffn_channel=None):
        ...
        self.depthwise = nn.Conv2d(
            in_channels=c, out_channels=ffn_channel, kernel_size=3, padding=1, stride=1, groups=c, bias=True, dilation=1
        )
...
class DBlock(nn.Module):
    ...
    def __init__(self, inc, c, DW_Expand=2, FFN_Expand=2, dilations=None, extra_depth_wise=False):
...
if __name__ == "__main__":
    ...
    module = DBlock(in_channel, out_channel).to(device)
