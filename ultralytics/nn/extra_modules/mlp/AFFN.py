"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2026-AFFN.png
ultralytics/nn/module_images/CVPR2026-AFFN.md
...
class AFFN(nn.Module):
    ...
    def forward(self, x):
        ...
        # 重组
        x = rearrange(x_patch_new, "b c h w ph pw -> b c (h ph) (w pw)", ph=self.patch_size, pw=self.patch_size).to(
