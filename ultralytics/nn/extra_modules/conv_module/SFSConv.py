"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2024-SFSConv.png
ultralytics/nn/module_images/CVPR2024-SFSConv.md
论文链接：https://openaccess.thecvf.com/content/CVPR2024/papers/Li_Unleashing_Channel_Potential_Space-Frequency_Selection_Convolution_for_SAR_Object_Detection_CVPR_2024_paper.pdf.
"""
...
class GaborSingle(nn.Module):
    ...
    def forward(self, x):
        ...
        # 删掉 F.pad + F.max_pool2d，避免 spatial -1 与 SPU 分支错位
        return out
...
if __name__ == "__main__":
    ...
    module = SFS_Conv(in_channel, out_channel).to(device)
