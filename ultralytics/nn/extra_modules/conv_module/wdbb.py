"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/WideDBB.png
...
class WideDiverseBranchBlock(nn.Module):
    ...
    def _add_to_square_kernel(self, square_kernel, asym_kernel):
        """Used to add an asymmetric kernel to the center of a square kernel square_kernel : the square kernel to which
        the asymmetric kernel will be added asym_kernel : the asymmetric kernel that will be added to the
        square kernel.
        """
    ...
    def get_equivalent_kernel_bias_1xk_kx1_kxk(self):
        """Used to calculate the equivalent kernel and bias of the fused convolution layer in deploy mode.
        """
    ...
    def get_equivalent_kernel_bias(self):
        ...
        k_1x1_kxk_merged, b_1x1_kxk_merged = transIII_1x1_kxk(
            k_1x1_kxk_first, b_1x1_kxk_first, k_1x1_kxk_second, b_1x1_kxk_second, groups=self.groups
        )
        ...
        if hasattr(self.dbb_avg, "conv"):
            ...
            k_1x1_avg_merged, b_1x1_avg_merged = transIII_1x1_kxk(
                k_1x1_avg_first, b_1x1_avg_first, k_1x1_avg_second, b_1x1_avg_second, groups=self.groups
            )
        else:
            k_1x1_avg_merged, b_1x1_avg_merged = k_1x1_avg_second, b_1x1_avg_second

        return transII_addbranch(
            (k_origin, k_1x1, k_1x1_kxk_merged, k_1x1_avg_merged), (b_origin, b_1x1, b_1x1_kxk_merged, b_1x1_avg_merged)
        )
