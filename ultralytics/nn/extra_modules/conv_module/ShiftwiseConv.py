"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2025-ShiftwiseConv.png
...
class LoRAConvsByWeight(nn.Module):
    """merge LoRA1 LoRA2 shuffle channel by weights rather index.
    """
    ...
    def shift(self, kernels):
        """We assume the conv does not change the feature map size, so padding = bigger_kernel_size//2. Otherwise, you
        may configure padding as you wish, and change the padding of small_conv accordingly.
        """
