''' 
本文件由BiliBili：魔傀面具整理    
ultralytics/nn/module_images/CVPR2024-DCNV4.md
...
try:
    from compile_module.DCNv4_op.DCNv4 import DCNv4
except:
    pass
...
if __name__ == '__main__':  
    ...
    module = DeformConvV4(in_channel, out_channel).to(device)
