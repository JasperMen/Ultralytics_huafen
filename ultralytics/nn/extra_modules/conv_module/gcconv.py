'''
本文件由BiliBili：魔傀面具整理    
ultralytics/nn/module_images/CVPR2025-GCConv.png
ultralytics/nn/module_images/CVPR2025-GCConv.md
论文链接：https://arxiv.org/pdf/2503.03325
'''   
...
if __name__ == '__main__':
    ...
    module = GCConv(in_channel, out_channel).to(device) 
