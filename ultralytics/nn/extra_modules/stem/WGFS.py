"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/自研模块-WGFS.png
ultralytics/nn/module_images/自研模块-WGFS.md.
"""
...
class HaarCut(nn.Module):
    ...
    Decomposes 2x2 pixel neighborhoods into 4 orthogonal sub-bands (LL low-freq, LH horizontal-detail, HL
    vertical-detail, HH diagonal-detail) with independent sigmoid gates to learn task-adaptive band importance.
    """
...
if __name__ == "__main__":
    ...
    half_module = WGFS(in_channel, out_channel).cuda().half().eval()
    with torch.no_grad():
