"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/自研模块-DPAS.png
ultralytics/nn/module_images/自研模块-DPAS.md.
"""
...
class PathGate(nn.Module):
    ...
    def __init__(self, channel, num_paths, reduction=4):
        ...
        self.fc = nn.Sequential(
            nn.Conv2d(channel, hidden, 1, bias=False), nn.SiLU(), nn.Conv2d(hidden, num_paths, 1, bias=False)
        )
...
if __name__ == "__main__":
    ...
    half_module = DPAS(in_channel, out_channel).cuda().half().eval()
    with torch.no_grad():
