'''
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/ICCV2023-RepStem.png 
ultralytics/nn/module_images/ICCV2023-RepStem.md 
论文链接：https://arxiv.org/pdf/2303.14189    
'''     
...
if __name__ == '__main__':     
    ...
    module = RepStem(in_channel, out_channel).to(device)
