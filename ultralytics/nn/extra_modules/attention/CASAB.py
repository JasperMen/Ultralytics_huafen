"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2025-CASAB.png
ultralytics/nn/module_images/CVPR2025-CASAB.md
...
class CASAB(nn.Module):
    ...
    This module combines channel attention and spatial attention to selectively emphasize the most important channels
    and spatial regions in feature maps.
    """
