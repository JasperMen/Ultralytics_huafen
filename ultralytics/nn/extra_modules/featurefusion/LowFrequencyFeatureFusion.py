"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/自研模块-LowFrequencyFeatureFusion.png
ultralytics/nn/module_images/自研模块-LowFrequencyFeatureFusion.md.
"""
...
class LowFrequencyFeatureFusion(nn.Module):
    ...
    def __init__(
        ...
        self.out_project = nn.Conv2d(out_channels * 2, out_channels, kernel_size=3, stride=1, padding=1, bias=bias)
    ...
    def forward(self, inputs):
        ...
        gate = self.gate(shared_low_energy.to(dtype=original_dtype)).to(dtype=spectra[0].real.dtype)
