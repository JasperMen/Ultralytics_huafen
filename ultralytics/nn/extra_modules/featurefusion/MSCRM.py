"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/自研模块-MSCRM.png
ultralytics/nn/module_images/自研模块-MSCRM.md.
"""
...
class MSCRM(nn.Module):
    def __init__(self, in_channel, out_channel, n_strips: int = 4):
        ...
        self.conv_fuse = Conv(out_channel, out_channel, 3, act=nn.ReLU)
...
if __name__ == "__main__":
    ...
    half_module = MSCRM([channel_1, channel_2], ouc_channel).cuda().half().eval()
    with torch.no_grad():
