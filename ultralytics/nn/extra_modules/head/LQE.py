...
class Detect_LQE(Detect):
    ...
    def one2many(self):
        ...
        return {"box_head": self.cv2, "cls_head": self.cv3, "lqe_head": self.lqe}

    @property
    def one2one(self):
        """Returns the one-to-one head components."""
        return {"box_head": self.one2one_cv2, "cls_head": self.one2one_cv3, "lqe_head": self.one2one_lqe}
...
class Segment_LQE(Detect_LQE):
    ...
    @property
    def one2many(self):
        return {"box_head": self.cv2, "cls_head": self.cv3, "lqe_head": self.lqe, "mask_head": self.cv4}
...
class OBB_LQE(Detect_LQE):
    ...
    @property
    def one2many(self):
        return {"box_head": self.cv2, "cls_head": self.cv3, "lqe_head": self.lqe, "angle_head": self.cv4}
...
class Pose_LQE(Detect_LQE):
    ...
    @property
    def one2many(self):
        return {"box_head": self.cv2, "cls_head": self.cv3, "lqe_head": self.lqe, "pose_head": self.cv4}
