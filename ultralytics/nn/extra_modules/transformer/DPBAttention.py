"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/ICLR2022-DPBAttention.png
...
class DPB_Attention(nn.Module):
    ...
    def __init__(self, dim, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0.0, proj_drop=0.0, position_bias=True):
    ...
    def forward(self, x, mask=None):
        ...
        if self.position_bias:
            ...
            biases = biases.flatten(1).transpose(0, 1).contiguous().to(dtype=x.dtype)
