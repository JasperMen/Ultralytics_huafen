"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2025-TAB.md
ultralytics/nn/module_images/CVPR2025-TAB.png
...
def center_iter(x, means, buckets=None):
    b, _l, d, dtype, num_tokens = *x.shape, x.dtype, means.shape[0]
...
class TAB(nn.Module):
    def __init__(self, dim, heads=8, n_iter=3, num_tokens=8, group_size=128, ema_decay=0.999):
        super().__init__()
