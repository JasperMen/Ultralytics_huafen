"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/AAAI2026-DHOGSA.png
ultralytics/nn/module_images/AAAI2026-DHOGSA.md
...
class DHOGSA(nn.Module):
    ...
    def merge_patches(self, patches, shape_info):
        _b, _c, h, w, pad_h, pad_w, n_h, n_w = shape_info
        patches = rearrange(
    ...
    def apply_hog_to_patch(self, x_half):
        ...
        b, n_patches, c, _patch_pixels = patches_x.shape
    ...
    def forward(self, x):
        ...
        b, _n_patches, _n_bins = hog_features.shape
...
if __name__ == "__main__":
    ...
    module = DHOGSA(channel, num_heads=8).to(device)
