"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/TIP2020-ContextGuidedBlock_Down.png
...
class ContextGuidedBlock(nn.Module):
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16, add=True):
        ...
        self.F_sur = nn.Conv2d(
            n, n, 3, padding=autopad(3, None, dilation_rate), dilation=dilation_rate, groups=n
        )  # surrounding context
...
class ContextGuidedBlock_Down(nn.Module):
    ...
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16):
        ...
        self.F_sur = nn.Conv2d(
            nOut, nOut, 3, padding=autopad(3, None, dilation_rate), dilation=dilation_rate, groups=nOut
        )
