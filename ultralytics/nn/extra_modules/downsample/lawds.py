"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/自研模块-Light Adaptive-weight downsampling.png
...
class LAWDS(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, group=16) -> None:
        ...
        self.attention = nn.Sequential(nn.AvgPool2d(kernel_size=3, stride=1, padding=1), Conv(in_ch, in_ch, k=1))
