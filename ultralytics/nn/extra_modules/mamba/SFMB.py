...
class MB(nn.Module):
    ...
    def forward(self, x: torch.Tensor, **kwargs):
        ...
        y1 = F.layer_norm(
            y1.float(),
            self.out_norm1.normalized_shape,
            self.out_norm1.weight.float(),
            self.out_norm1.bias.float(),
            self.out_norm1.eps,
        ).to(dtype=x.dtype)
        ...
        y2 = F.layer_norm(
            y2.float(),
            self.out_norm2.normalized_shape,
            self.out_norm2.weight.float(),
            self.out_norm2.bias.float(),
            self.out_norm2.eps,
        ).to(dtype=x.dtype)
        ...
        y3 = F.layer_norm(
            y3.float(),
            self.out_norm3.normalized_shape,
            self.out_norm3.weight.float(),
            self.out_norm3.bias.float(),
            self.out_norm3.eps,
        ).to(dtype=x.dtype)
