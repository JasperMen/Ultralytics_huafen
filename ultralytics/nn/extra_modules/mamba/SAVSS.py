'''     
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2025-SAVSS.png 
SCSegamba中的SAVSS模块     
论文链接：https://arxiv.org/abs/2503.01113    
'''     
...
class SAVSS(nn.Module):
    ...
    def forward(self, x):
        ...
        orders, inverse_orders, directions = self.sass((H, W))    
        ...
        return out.permute(0, 2, 1).view([batch_size, channel, H, W]).contiguous() # N L C -> B C H W
...
if __name__ == '__main__':
    ...
    module = SAVSS(channel).to(device) 
