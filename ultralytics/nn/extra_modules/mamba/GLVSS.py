'''
本文件由BiliBili：魔傀面具整理   
ultralytics/nn/module_images/TGRS2025-GLVSS.png
ultralytics/nn/module_images/TGRS2025-GLVSS.md
...
class GL_VSS(nn.Module):  
    ...
    def __init__(
        ...
        self.channel_down = Conformity(dim, dim)
...
if __name__ == '__main__':
    ...
    module = GL_VSS(channel).to(device)
