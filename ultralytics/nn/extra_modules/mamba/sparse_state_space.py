"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/CVPR2026-SparseStateSpace.md
ultralytics/nn/module_images/CVPR2026-SparseStateSpace.png
...
if __name__ == "__main__":
    ...
    module = SparseStateSpace(channel).to(device)
