'''     
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/ICCV2025-TinyVIM.md   
ultralytics/nn/module_images/ICCV2025-TinyVIM.png   
论文链接：https://arxiv.org/abs/2411.17473
''' 
...
def cross_selective_scan(     
    ...
    y = F.layer_norm(y.float(), out_norm.normalized_shape, out_norm.weight.float(), out_norm.bias.float(), out_norm.eps).view(B, H, W, -1)   
...
if __name__ == '__main__':
    ...
    module = TViMBlock(channel).to(device)
