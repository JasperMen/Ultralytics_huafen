"""
本文件由BiliBili：魔傀面具整理
ultralytics/nn/module_images/ICCV2019-CARAFE.png
...
class CARAFE(nn.Module):
    def __init__(self, inc, k_enc=3, k_up=5, c_mid=64, scale=2):
        """The unofficial implementation of the CARAFE module. The details are in "https://arxiv.org/abs/1905.02188".
