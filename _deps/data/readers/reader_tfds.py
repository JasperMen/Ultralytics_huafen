...
try:
    ...
    try:
        ...
        print(
            ...
            "Please update or use tfds-nightly for better fine-grained split behavior."
        )
...
class ReaderTfds(Reader):
    ...
    * This wrapper is currently configured to return individual, decompressed image samples from the TFDS
    ...
    def __init__(
        ...
        # FIXME need to determine if reinit_each_iter is necessary. I'm don't completely trust behavior
    ...
    def _lazy_init(self):
        ...
        NOTE: There will be problems if you try to reuse this dataset across different loader/worker
        ...
        ds = self.builder.as_dataset(
            ...
            decoders={"image": decode_example(channels=1 if self.input_img_mode == "L" else 3)},
        ...
        if self.is_training or self.repeats > 1:
            # to prevent excessive drop_last batch behavior w/ IterableDatasets
