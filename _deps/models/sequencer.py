...
import torch
from timm.data import DEFAULT_CROP_PCT, IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from timm.layers import ClassifierHead, DropPath, Mlp, PatchEmbed, lecun_normal_
...
class Sequencer2d(nn.Module):
    def __init__(
        ...
        for i, _ in enumerate(embed_dims):
            ...
            self.feature_info += [{"num_chs": prev_dim, "reduction": reductions[i], "module": f"stages.{i}"}]
