...
from timm.layers import ConvNormAct, HybridEmbed, StdConv2d, StdConv2dSame, to_ntuple
...
def vit_tiny_r_s16_p8_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 8, "embed_dim": 192, "depth": 12, "num_heads": 3}
...
def vit_small_r26_s32_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"embed_dim": 384, "depth": 12, "num_heads": 6}
    model = _create_vision_transformer_hybrid(
...
def vit_base_r26_s32_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    backbone = _resnetv2((2, 2, 2, 2), **kwargs)
    model_args = {"embed_dim": 768, "depth": 12, "num_heads": 12}
    model = _create_vision_transformer_hybrid(
...
def vit_base_r50_s16_384(pretrained=False, **kwargs) -> VisionTransformer:
    """R50+ViT-B/16 hybrid from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned from
    in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    backbone = _resnetv2((3, 4, 9), **kwargs)
    model_args = {"embed_dim": 768, "depth": 12, "num_heads": 12}
    model = _create_vision_transformer_hybrid(
...
def vit_large_r50_s32_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"embed_dim": 1024, "depth": 24, "num_heads": 16}
    model = _create_vision_transformer_hybrid(
...
def vit_small_resnet26d_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"embed_dim": 768, "depth": 8, "num_heads": 8, "mlp_ratio": 3}
    model = _create_vision_transformer_hybrid(
...
def vit_base_mci_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"embed_dim": 768, "depth": 12, "num_heads": 12, "no_embed_class": True}
    model = _create_vision_transformer_hybrid(
        "vit_base_mci_224",
        backbone=backbone,
        embed_args={"proj": False},
        pretrained=pretrained,
