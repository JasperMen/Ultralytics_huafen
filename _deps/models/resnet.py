...
__all__ = ["BasicBlock", "Bottleneck", "ResNet"]  # model_registry will add each entrypoint fn to this
...
def drop_blocks(drop_prob: float = 0.0) -> list[partial | None]:
...
def make_blocks(
    block_fns: tuple[type[BasicBlock | Bottleneck], ...],
    channels: tuple[int, ...],
...
class ResNet(nn.Module):
    ...
    * have conv-bn-act ordering
    ...
    This ResNet impl supports a number of stem and downsample options based on the v1c, v1d, v1e, and v1s variants
    included in the MXNet Gluon ResNetV1b model. The C and D variants are also discussed in the 'Bag of Tricks' paper:
    https://arxiv.org/pdf/1812.01187. The B variant is equivalent to torchvision default.
    ...
    * same c, d, e, s variants as ResNet can be enabled
    ...
    def __init__(
        ...
        down_kernel_size: int = 1,
        avg_down: bool = False,
        channels: tuple[int, ...] | None = (64, 128, 256, 512),
        ...
        Args:
            ...
            block_reduce_first (int): Reduction factor for first convolution output width of residual blocks, 1 for all
                archs except senets, where 2 (default 1)
        ...
        if replace_stem_pool:
            ...
            if aa_layer is not None:
                if issubclass(aa_layer, nn.AvgPool2d):
                    ...
                    self.maxpool = nn.Sequential(
                        *[nn.MaxPool2d(kernel_size=3, stride=1, padding=1), aa_layer(channels=inplanes, stride=2, **dd)]
                    )
            else:
    ...
    @torch.jit.ignore
    def get_classifier(self, name_only: bool = False) -> str | nn.Module:
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "resnet18d.ra4_e3600_r224_in1k": _rcfg(
            hf_hub_id="timm/", mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=0.9, first_conv="conv1.0"
        ),
        ...
        "resnet34.ra4_e3600_r224_in1k": _rcfg(
            hf_hub_id="timm/", mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=0.9
        ),
        ...
        "seresnet200d.untrained": _ttcfg(first_conv="conv1.0", input_size=(3, 256, 256), pool_size=(8, 8)),
        "seresnet269d.untrained": _ttcfg(first_conv="conv1.0", input_size=(3, 256, 256), pool_size=(8, 8)),
        ...
        "seresnextaa101d_32x8d.sw_in12k_ft_in1k": _ttcfg(hf_hub_id="timm/", first_conv="conv1.0", test_crop_pct=1.0),
        ...
        "resnetaa50d.sw_in12k": _ttcfg(
            hf_hub_id="timm/", num_classes=11821, first_conv="conv1.0", crop_pct=0.95, test_crop_pct=1.0
        ),
...
def resnet18(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": BasicBlock, "layers": (2, 2, 2, 2)}
...
def resnet18d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": BasicBlock, "layers": (2, 2, 2, 2), "stem_width": 32, "stem_type": "deep", "avg_down": True}
...
def resnet34(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": BasicBlock, "layers": (3, 4, 6, 3)}
...
def resnet34d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": BasicBlock, "layers": (3, 4, 6, 3), "stem_width": 32, "stem_type": "deep", "avg_down": True}
...
def resnet26(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (2, 2, 2, 2)}
...
def resnet26d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (2, 2, 2, 2), "stem_width": 32, "stem_type": "deep", "avg_down": True}
...
def resnet50(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3)}
...
def resnet50c(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "stem_width": 32, "stem_type": "deep"}
...
def resnet50d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "stem_width": 32, "stem_type": "deep", "avg_down": True}
...
def resnet50s(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "stem_width": 64, "stem_type": "deep"}
...
def resnet101(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3)}
...
def resnet101c(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "stem_width": 32, "stem_type": "deep"}
...
def resnet101d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "stem_width": 32, "stem_type": "deep", "avg_down": True}
...
def resnet101s(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "stem_width": 64, "stem_type": "deep"}
...
def resnet152(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 8, 36, 3)}
...
def resnet152c(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 8, 36, 3), "stem_width": 32, "stem_type": "deep"}
...
def resnet152d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 8, 36, 3), "stem_width": 32, "stem_type": "deep", "avg_down": True}
...
def resnet152s(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 8, 36, 3), "stem_width": 64, "stem_type": "deep"}
...
def resnet200(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 24, 36, 3)}
...
def wide_resnet50_2(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a Wide ResNet-50-2 model. The model is the same as ResNet except for the bottleneck number of channels
    which is twice larger in every block. The number of channels in outer 1x1 convolutions is the same, e.g. last
    block in ResNet-50 has 2048-512-2048 channels, and in Wide ResNet-50-2 has 2048-1024-2048.
    """
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "base_width": 128}
...
def wide_resnet101_2(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a Wide ResNet-101-2 model. The model is the same as ResNet except for the bottleneck number of
    channels which is twice larger in every block. The number of channels in outer 1x1 convolutions is the same.
    """
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "base_width": 128}
...
def resnet50_gn(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "norm_layer": "groupnorm"}
...
def resnext50_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "cardinality": 32, "base_width": 4}
...
def resnext101_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "cardinality": 32, "base_width": 4}
...
def resnext101_32x8d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "cardinality": 32, "base_width": 8}
...
def resnext101_32x16d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "cardinality": 32, "base_width": 16}
...
def resnext101_32x32d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "cardinality": 32, "base_width": 32}
...
def resnext101_64x4d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "cardinality": 64, "base_width": 4}
...
def ecaresnet26t(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs an ECA-ResNeXt-26-T model. This is technically a 28 layer ResNet, like a 'D' bag-of-tricks model but
    with tiered 24, 32, 64 channels in the deep stem and ECA attn.
    """
    model_args = {
        "block": Bottleneck,
        "layers": (2, 2, 2, 2),
...
def ecaresnet50d_pruned(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-50-D model pruned with eca. The pruning has been obtained using
    https://arxiv.org/pdf/2002.08258.pdf.
    """
    model_args = {
        "block": Bottleneck,
        "layers": (3, 4, 6, 3),
...
def ecaresnet50t(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs an ECA-ResNet-50-T model. Like a 'D' bag-of-tricks model but with tiered 24, 32, 64 channels in the
    deep stem and ECA attn.
    """
    model_args = {
        "block": Bottleneck,
        "layers": (3, 4, 6, 3),
...
def ecaresnet101d_pruned(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-101-D model pruned with eca. The pruning has been obtained using
    https://arxiv.org/pdf/2002.08258.pdf.
    """
    model_args = {
        "block": Bottleneck,
...
def ecaresnext26t_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs an ECA-ResNeXt-26-T model. This is technically a 28 layer ResNet, like a 'D' bag-of-tricks model but
    with tiered 24, 32, 64 channels in the deep stem. This model replaces SE module with the ECA module.
    """
    model_args = {
        "block": Bottleneck,
        "layers": (2, 2, 2, 2),
...
def ecaresnext50t_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs an ECA-ResNeXt-50-T model. This is technically a 28 layer ResNet, like a 'D' bag-of-tricks model but
    with tiered 24, 32, 64 channels in the deep stem. This model replaces SE module with the ECA module.
    """
    model_args = {
        "block": Bottleneck,
...
def seresnet101(pretrained: bool = False, **kwargs) -> ResNet:
    model_args = {"block": Bottleneck, "layers": (3, 4, 23, 3), "block_args": {"attn_layer": "se"}}
    return _create_resnet("seresnet101", pretrained, **dict(model_args, **kwargs))


@register_model
def seresnet152(pretrained: bool = False, **kwargs) -> ResNet:
    model_args = {"block": Bottleneck, "layers": (3, 8, 36, 3), "block_args": {"attn_layer": "se"}}
...
def seresnext26d_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a SE-ResNeXt-26-D model.` This is technically a 28 layer ResNet, using the 'D' modifier from Gluon /
...
def seresnext26t_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a SE-ResNet-26-T model. This is technically a 28 layer ResNet, like a 'D' bag-of-tricks model but with
...
def resnetblur18(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": BasicBlock, "layers": (2, 2, 2, 2), "aa_layer": BlurPool2d}
...
def resnetblur50(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "aa_layer": BlurPool2d}
...
def resnetaa50(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = {"block": Bottleneck, "layers": (3, 4, 6, 3), "aa_layer": nn.AvgPool2d}
...
def resnetrs50(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-50 model. Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
...
def resnetrs101(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-101 model. Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
    attn_layer = partial(get_attn("se"), rd_ratio=0.25)
    model_args = {
...
def resnetrs152(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-152 model. Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
    attn_layer = partial(get_attn("se"), rd_ratio=0.25)
    model_args = {
...
def resnetrs200(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-200 model. Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
    attn_layer = partial(get_attn("se"), rd_ratio=0.25)
    model_args = {
...
def resnetrs270(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-270 model. Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
    attn_layer = partial(get_attn("se"), rd_ratio=0.25)
    model_args = {
...
def resnetrs350(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-350 model. Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
    attn_layer = partial(get_attn("se"), rd_ratio=0.25)
    model_args = {
...
def resnetrs420(pretrained: bool = False, **kwargs) -> ResNet:
    """Constructs a ResNet-RS-420 model Paper: Revisiting ResNets - https://arxiv.org/abs/2103.07579 Pretrained weights
    from https://github.com/tensorflow/tpu/tree/bee9c4f6/models/official/resnet/resnet_rs.
    """
    attn_layer = partial(get_attn("se"), rd_ratio=0.25)
    model_args = {
