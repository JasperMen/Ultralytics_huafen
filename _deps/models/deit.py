...
from timm.models.vision_transformer import VisionTransformer, checkpoint_filter_fn, trunc_normal_
...
class VisionTransformerDistilled(VisionTransformer):
    ...
    def _pos_embed(self, x):
        ...
        if self.no_embed_class:
            ...
            x = x + pos_embed
            x = torch.cat(
                (self.cls_token.expand(x.shape[0], -1, -1), self.dist_token.expand(x.shape[0], -1, -1), x), dim=1
            )
        else:
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "deit_tiny_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_tiny_patch16_224-a1311bcf.pth"
        ),
        "deit_small_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_small_patch16_224-cd65a155.pth"
        ),
        "deit_base_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_base_patch16_224-b5f2ef4d.pth"
        ),
        ...
        "deit3_small_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_small_224_1k.pth"
        ),
        ...
        "deit3_medium_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_medium_224_1k.pth"
        ),
        "deit3_base_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_base_224_1k.pth"
        ),
        ...
        "deit3_large_patch16_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_large_224_1k.pth"
        ),
        ...
        "deit3_huge_patch14_224.fb_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_huge_224_1k.pth"
        ),
        "deit3_small_patch16_224.fb_in22k_ft_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_small_224_21k.pth", crop_pct=1.0
        ),
        ...
        "deit3_medium_patch16_224.fb_in22k_ft_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_medium_224_21k.pth", crop_pct=1.0
        ),
        "deit3_base_patch16_224.fb_in22k_ft_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_base_224_21k.pth", crop_pct=1.0
        ),
        ...
        "deit3_large_patch16_224.fb_in22k_ft_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_large_224_21k.pth", crop_pct=1.0
        ),
        ...
        "deit3_huge_patch14_224.fb_in22k_ft_in1k": _cfg(
            hf_hub_id="timm/", url="https://dl.fbaipublicfiles.com/deit/deit_3_huge_224_21k_v1.pth", crop_pct=1.0
        ),
    }
)
...
def deit_tiny_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-tiny model @ 224x224 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
...
def deit_small_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
...
def deit_base_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT base model @ 224x224 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
...
def deit_base_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT base model @ 384x384 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12}
...
def deit_tiny_distilled_patch16_224(pretrained=False, **kwargs) -> VisionTransformerDistilled:
    """DeiT-tiny distilled model @ 224x224 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {"patch_size": 16, "embed_dim": 192, "depth": 12, "num_heads": 3}
    model = _create_deit(
...
def deit_small_distilled_patch16_224(pretrained=False, **kwargs) -> VisionTransformerDistilled:
    """DeiT-small distilled model @ 224x224 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {"patch_size": 16, "embed_dim": 384, "depth": 12, "num_heads": 6}
    model = _create_deit(
...
def deit_base_distilled_patch16_224(pretrained=False, **kwargs) -> VisionTransformerDistilled:
    """DeiT-base distilled model @ 224x224 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12}
    model = _create_deit(
...
def deit_base_distilled_patch16_384(pretrained=False, **kwargs) -> VisionTransformerDistilled:
    """DeiT-base distilled model @ 384x384 from paper (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12}
    model = _create_deit(
...
def deit3_small_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 small model @ 224x224 from paper (https://arxiv.org/abs/2204.07118). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
...
def deit3_small_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 small model @ 384x384 from paper (https://arxiv.org/abs/2204.07118). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
...
def deit3_medium_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 medium model @ 224x224 (https://arxiv.org/abs/2012.12877). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
...
def deit3_base_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 base model @ 224x224 from paper (https://arxiv.org/abs/2204.07118). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
...
def deit3_base_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 base model @ 384x384 from paper (https://arxiv.org/abs/2204.07118). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
...
def deit3_large_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 large model @ 224x224 from paper (https://arxiv.org/abs/2204.07118). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
...
def deit3_large_patch16_384(pretrained=False, **kwargs) -> VisionTransformer:
    """DeiT-3 large model @ 384x384 from paper (https://arxiv.org/abs/2204.07118). ImageNet-1k weights from
    https://github.com/facebookresearch/deit.
    """
    model_args = {
        "patch_size": 16,
