...
class Stem(nn.Module):
    """Stem implemented by a layer of convolution. Conv2d params constant across all models.
    """
...
class Downsampling(nn.Module):
    ...
    def __init__(
        ...
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size=kernel_size, stride=stride, padding=padding, **dd)
...
class Attention(nn.Module):
    """Vanilla self-attention from Transformer: https://arxiv.org/abs/1706.03762. Modified from timm.
    """
...
class SepConv(nn.Module):
    r"""Inverted separable convolution from MobileNetV2: https://arxiv.org/abs/1801.04381."""
...
class MetaFormerBlock(nn.Module):
    ...
    def __init__(
        ...
        res_scale_init_value: float | None = None,
        device=None,
        dtype=None,
        **kwargs,
    ):
        ...
        self.mlp = Mlp(dim, int(4 * dim), act_layer=mlp_act, bias=mlp_bias, drop=proj_drop, use_conv=use_nchw, **dd)
...
class MetaFormerStage(nn.Module):
    def __init__(
        ...
        mlp_act: type[nn.Module] = StarReLU,
        mlp_bias: bool = False,
        downsample_norm: type[nn.Module] | None = LayerNorm2d,
        norm_layer: type[nn.Module] = LayerNorm2d,
        proj_drop: float = 0.0,
        dp_rates: list[float] = [0.0] * 2,
        layer_scale_init_value: float | None = None,
        res_scale_init_value: float | None = None,
        device=None,
        dtype=None,
...
class MetaFormer(nn.Module):
    ...
    def __init__(
        ...
        token_mixers: type[nn.Module] | list[type[nn.Module]] = Pooling,
        mlp_act: type[nn.Module] = StarReLU,
        mlp_bias: bool = False,
        drop_path_rate: float = 0.0,
        proj_drop_rate: float = 0.0,
        drop_rate: float = 0.0,
        layer_scale_init_values: float | list[float] | None = None,
        res_scale_init_values: tuple[float | None, ...] | list[float | None] = (None, None, 1.0, 1.0),
        downsample_norm: type[nn.Module] | None = LayerNorm2dNoBias,
        norm_layers: type[nn.Module] | list[type[nn.Module]] = LayerNorm2dNoBias,
        ...
        **kwargs,
        ...
        for i in range(self.num_stages):
            ...
            prev_dim = dims[i]
            self.feature_info += [{"num_chs": dims[i], "reduction": 2 ** (i + 2), "module": f"stages.{i}"}]
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "convformer_s18.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_s18.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_s18.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_s18.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "convformer_s36.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_s36.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_s36.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_s36.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_s36.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "convformer_m36.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_m36.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_m36.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_m36.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_m36.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "convformer_b36.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_b36.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_b36.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "convformer_b36.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "convformer_b36.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "caformer_s18.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_s18.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_s18.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_s18.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_s18.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "caformer_s36.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_s36.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_s36.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_s36.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_s36.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "caformer_m36.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_m36.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_m36.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_m36.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_m36.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
        "caformer_b36.sail_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_b36.sail_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_b36.sail_in22k_ft_in1k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2"),
        "caformer_b36.sail_in22k_ft_in1k_384": _cfg(
            hf_hub_id="timm/", classifier="head.fc.fc2", input_size=(3, 384, 384), pool_size=(12, 12)
        ),
        "caformer_b36.sail_in22k": _cfg(hf_hub_id="timm/", classifier="head.fc.fc2", num_classes=21841),
    }
)
...
def poolformerv2_s12(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[2, 2, 6, 2], dims=[64, 128, 320, 512], norm_layers=GroupNorm1NoBias, use_mlp_head=False, **kwargs
    )
...
def poolformerv2_s24(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[4, 4, 12, 4], dims=[64, 128, 320, 512], norm_layers=GroupNorm1NoBias, use_mlp_head=False, **kwargs
    )
...
def poolformerv2_s36(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[6, 6, 18, 6], dims=[64, 128, 320, 512], norm_layers=GroupNorm1NoBias, use_mlp_head=False, **kwargs
    )
...
def poolformerv2_m36(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[6, 6, 18, 6], dims=[96, 192, 384, 768], norm_layers=GroupNorm1NoBias, use_mlp_head=False, **kwargs
    )
...
def poolformerv2_m48(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[8, 8, 24, 8], dims=[96, 192, 384, 768], norm_layers=GroupNorm1NoBias, use_mlp_head=False, **kwargs
    )
...
def convformer_s18(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[3, 3, 9, 3], dims=[64, 128, 320, 512], token_mixers=SepConv, norm_layers=LayerNorm2dNoBias, **kwargs
    )
...
def convformer_s36(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[3, 12, 18, 3], dims=[64, 128, 320, 512], token_mixers=SepConv, norm_layers=LayerNorm2dNoBias, **kwargs
    )
...
def convformer_m36(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[3, 12, 18, 3], dims=[96, 192, 384, 576], token_mixers=SepConv, norm_layers=LayerNorm2dNoBias, **kwargs
    )
...
def convformer_b36(pretrained=False, **kwargs) -> MetaFormer:
    model_kwargs = dict(
        depths=[3, 12, 18, 3], dims=[128, 256, 512, 768], token_mixers=SepConv, norm_layers=LayerNorm2dNoBias, **kwargs
    )
