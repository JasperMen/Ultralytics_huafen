...
__all__ = ["clean_state_dict", "load_checkpoint", "load_state_dict", "remap_state_dict", "resume_checkpoint"]
...
def remap_state_dict(state_dict: dict[str, Any], model: torch.nn.Module, allow_reshape: bool = True) -> dict[str, Any]:
