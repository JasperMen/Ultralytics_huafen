...
class Mixed_7a(nn.Module):
    def __init__(
        ...
        self.branch0 = nn.Sequential(
            conv_block(1088, 256, kernel_size=1, stride=1, **dd), conv_block(256, 384, kernel_size=3, stride=2, **dd)
        )

        self.branch1 = nn.Sequential(
            conv_block(1088, 256, kernel_size=1, stride=1, **dd), conv_block(256, 288, kernel_size=3, stride=2, **dd)
        )
...
class InceptionResnetV2(nn.Module):
    def __init__(
        ...
        self.feature_info = [{"num_chs": 64, "reduction": 2, "module": "conv2d_2b"}]
        ...
        self.feature_info += [{"num_chs": 192, "reduction": 4, "module": "conv2d_4a"}]
        ...
        self.feature_info += [{"num_chs": 320, "reduction": 8, "module": "repeat"}]
        ...
        self.feature_info += [{"num_chs": 1088, "reduction": 16, "module": "repeat_1"}]
        ...
        self.feature_info += [{"num_chs": self.num_features, "reduction": 32, "module": "conv2d_7b"}]
