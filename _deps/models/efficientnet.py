...
from ._features import FeatureHooks, FeatureInfo, feature_take_indices
    ...
    * TinyNet
    ...
    def group_matcher(self, coarse: bool = False) -> dict[str, str | list]:
        ...
        return {
            ...
            "blocks": [(r"^blocks\.(\d+)" if coarse else r"^blocks\.(\d+)\.(\d+)", None), (r"conv_head|bn2", (99999,))],
        }
...
class EfficientNetFeatures(nn.Module):
    ...
    A work-in-progress feature extraction module for EfficientNet, to use as a backbone for segmentation and object
    detection models.
    """
...
def _gen_mnasnet_a1(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    Ref impl: https://github.com/tensorflow/tpu/tree/master/models/official/mnasnet Paper:
...
def _gen_mobilenet_v1(
    ...
    **kwargs,
    ...
    """Ref impl: https://github.com/tensorflow/models/blob/master/research/slim/nets/mobilenet/mobilenet_v2.py Paper:
...
def _gen_mobilenet_v2(
    ...
    **kwargs,
    ...
    """Generate MobileNet-V2 network Ref impl:
...
def _gen_fbnetc(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    Paper: https://arxiv.org/abs/1812.03443 Ref Impl:
    https://github.com/facebookresearch/maskrcnn-benchmark/blob/master/maskrcnn_benchmark/modeling/backbone/fbnet_modeldef.py

    NOTE: the impl above does not relate to the 'C' variant here, that was derived from paper, it was used to confirm
    some building block details
    """
    arch_def = [
        ["ir_r1_k3_s1_e1_c16"],
...
def _gen_efficientnet(
    ...
    **kwargs,
    ...
    Ref impl: https://github.com/tensorflow/tpu/blob/master/models/official/efficientnet/efficientnet_model.py Paper:
    https://arxiv.org/abs/1905.11946

    EfficientNet params name: (channel_multiplier, depth_multiplier, resolution, dropout_rate) 'efficientnet-b0': (1.0,
    1.0, 224, 0.2), 'efficientnet-b1': (1.0, 1.1, 240, 0.2), 'efficientnet-b2': (1.1, 1.2, 260, 0.3), 'efficientnet-b3':
    (1.2, 1.4, 300, 0.3), 'efficientnet-b4': (1.4, 1.8, 380, 0.4), 'efficientnet-b5': (1.6, 2.2, 456, 0.4),
    'efficientnet-b6': (1.8, 2.6, 528, 0.5), 'efficientnet-b7': (2.0, 3.1, 600, 0.5), 'efficientnet-b8': (2.2, 3.6, 672,
    0.5), 'efficientnet-l2': (4.3, 5.3, 800, 0.5),
...
def _gen_efficientnet_lite(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, **kwargs):
    ...
    Ref impl: https://github.com/tensorflow/tpu/tree/master/models/official/efficientnet/lite Paper:
    https://arxiv.org/abs/1905.11946

    EfficientNet params name: (channel_multiplier, depth_multiplier, resolution, dropout_rate) 'efficientnet-lite0':
    (1.0, 1.0, 224, 0.2), 'efficientnet-lite1': (1.0, 1.1, 240, 0.2), 'efficientnet-lite2': (1.1, 1.2, 260, 0.3),
    'efficientnet-lite3': (1.2, 1.4, 280, 0.3), 'efficientnet-lite4': (1.4, 1.8, 300, 0.3),
...
def _gen_efficientnetv2_base(
    ...
    Ref impl: https://github.com/google/automl/tree/master/efficientnetv2 Paper: `EfficientNetV2: Smaller Models and
...
def _gen_efficientnet_x(
    ...
    **kwargs,
    ...
    EfficientNet params name: (channel_multiplier, depth_multiplier, resolution, dropout_rate) 'efficientnet-x-b0':
    (1.0, 1.0, 224, 0.2), 'efficientnet-x-b1': (1.0, 1.1, 240, 0.2), 'efficientnet-x-b2': (1.1, 1.2, 260, 0.3),
    'efficientnet-x-b3': (1.2, 1.4, 300, 0.3), 'efficientnet-x-b4': (1.4, 1.8, 380, 0.4), 'efficientnet-x-b5': (1.6,
    2.2, 456, 0.4), 'efficientnet-x-b6': (1.8, 2.6, 528, 0.5), 'efficientnet-x-b7': (2.0, 3.1, 600, 0.5),
    'efficientnet-x-b8': (2.2, 3.6, 672, 0.5), 'efficientnet-l2': (4.3, 5.3, 800, 0.5),
...
def _gen_mixnet_s(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    Ref impl: https://github.com/tensorflow/tpu/tree/master/models/official/mnasnet/mixnet Paper:
...
default_cfgs = generate_default_cfgs(
    {
        ...
        "efficientnet_b5.sw_in12k_ft_in1k": _cfg(
            hf_hub_id="timm/", input_size=(3, 448, 448), pool_size=(14, 14), crop_pct=1.0, crop_mode="squash"
        ),
        "efficientnet_b5.sw_in12k": _cfg(
            hf_hub_id="timm/", input_size=(3, 416, 416), pool_size=(13, 13), crop_pct=0.95, num_classes=11821
        ),
        "efficientnet_b6.untrained": _cfg(url="", input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
        "efficientnet_b7.untrained": _cfg(url="", input_size=(3, 600, 600), pool_size=(19, 19), crop_pct=0.949),
        "efficientnet_b8.untrained": _cfg(url="", input_size=(3, 672, 672), pool_size=(21, 21), crop_pct=0.954),
        "efficientnet_l2.untrained": _cfg(url="", input_size=(3, 800, 800), pool_size=(25, 25), crop_pct=0.961),
        # FIXME experimental
        ...
        "efficientnet_x_b3.untrained": _cfg(url="", input_size=(3, 288, 288), pool_size=(9, 9), crop_pct=0.95),
        ...
        "efficientnet_lite1.untrained": _cfg(input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),
        "efficientnet_lite2.untrained": _cfg(input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890),
        "efficientnet_lite3.untrained": _cfg(input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
        "efficientnet_lite4.untrained": _cfg(input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
        ...
        "tf_efficientnetv2_b2.in1k": _cfg(
            ...
            hf_hub_id="timm/",
            input_size=(3, 208, 208),
            test_input_size=(3, 260, 260),
            pool_size=(7, 7),
            crop_pct=0.890,
        ),
        ...
        "test_efficientnet.r160_in1k": _cfg(
            hf_hub_id="timm/", input_size=(3, 160, 160), pool_size=(5, 5), crop_pct=0.95
        ),
...
def efficientnet_b0_g8_gn(pretrained=False, **kwargs) -> EfficientNet:
    ...
    model = _gen_efficientnet(
        ...
        group_size=8,
        norm_layer=partial(GroupNormAct, group_size=8),
...
def efficientnet_b0_g16_evos(pretrained=False, **kwargs) -> EfficientNet:
    ...
    model = _gen_efficientnet(
        "efficientnet_b0_g16_evos", group_size=16, channel_divisor=16, pretrained=pretrained, **kwargs
    )  # norm_layer=partial(EvoNorm2dS0, group_size=16),
    return model
...
def efficientnet_b3_gn(pretrained=False, **kwargs) -> EfficientNet:
    ...
    model = _gen_efficientnet(
        ...
        channel_divisor=16,
        norm_layer=partial(GroupNormAct, group_size=16),
        pretrained=pretrained,
        **kwargs,
    )
    return model
...
def efficientnetv2_rw_s(pretrained=False, **kwargs) -> EfficientNet:
    """EfficientNet-V2 Small (RW variant). NOTE: This is my initial (pre official code release) w/ some differences. See
    efficientnetv2_s and tf_efficientnetv2_s for versions that match the official w/ PyTorch vs TF padding.
    """
...
def test_efficientnet_ln(pretrained=False, **kwargs) -> EfficientNet:
    model = _gen_test_efficientnet(
        "test_efficientnet_ln", pretrained=pretrained, norm_layer=kwargs.pop("norm_layer", LayerNormAct2d), **kwargs
    )
    return model
