...
class TrainingTask(nn.Module):
    ...
    A training task encapsulates a complete forward pass including loss computation. Tasks return a dictionary
    containing the training loss and other components for logging.
    ...
    def prepare_distributed(self, device_ids: list | None = None, **ddp_kwargs) -> TrainingTask:
