...
from .byobnet import ByoBlockCfg, ByobNet, ByoModelCfg, interleave_blocks
...
model_cfgs = {
    ...
    "halonet_h1": ByoModelCfg(
        ...
        self_attn_kwargs={"block_size": 8, "halo_size": 3},
    ),
    "halonet26t": ByoModelCfg(
        ...
        stem_pool="maxpool",
        self_attn_layer="halo",
        self_attn_kwargs={"block_size": 8, "halo_size": 2},
    ),
    ...
    "halonet50ts": ByoModelCfg(
        blocks=(
            ...
            interleave_blocks(
                ...
                br=0.25,
                self_attn_layer="halo",
                self_attn_kwargs={"block_size": 8, "halo_size": 3, "num_heads": 4},
            ),
            interleave_blocks(types=("bottle", "self_attn"), d=6, c=1024, s=2, gs=0, br=0.25),
            interleave_blocks(types=("bottle", "self_attn"), d=3, c=2048, s=2, gs=0, br=0.25),
        ),
    ...
    "eca_halonext26ts": ByoModelCfg(
        ...
        attn_layer="eca",
        self_attn_layer="halo",
        self_attn_kwargs={"block_size": 8, "halo_size": 2, "dim_head": 16},
    ),
    ...
    "haloregnetz_b": ByoModelCfg(
        ...
        self_attn_layer="halo",
        self_attn_kwargs={"block_size": 7, "halo_size": 2, "qk_ratio": 0.33},
    ),
    # experimental
...
def _create_byoanet(variant: str, cfg_variant: str | None = None, pretrained: bool = False, **kwargs) -> ByobNet:
...
def halonet_h1(pretrained: bool = False, **kwargs) -> ByobNet:
    """HaloNet-H1. Halo attention in all stages as per the paper. NOTE: This runs very slowly!
    """
