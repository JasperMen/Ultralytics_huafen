...
from ._manipulate import adapt_input_conv, checkpoint, checkpoint_seq, named_apply
...
class ParallelScalingBlock(nn.Module):
    """Parallel ViT block (MLP & Attention in parallel) Based on: 'Scaling Vision Transformers to 22 Billion Parameters`
...
class DiffParallelScalingBlock(nn.Module):
    ...
    Combines the parallel MLP+Attention structure from 'Scaling Vision Transformers to 22 Billion Parameters'
    (https://arxiv.org/abs/2302.05442) with differential attention from 'Differential Transformer'
...
class ParallelThingsBlock(nn.Module):
    """Parallel ViT block (N parallel attention followed by N parallel MLP) Based on: `Three things everyone should know
    about Vision Transformers` - https://arxiv.org/abs/2203.09795.
    """
...
class VisionTransformer(nn.Module):
    ...
    def get_intermediate_layers(
        ...
        NOTE: This API is for backwards compat, favor using forward_intermediates() directly.
...
def resize_pos_embed(
    ...
    """Rescale the grid of position embeddings when loading from state_dict. *DEPRECATED* This function is being
    deprecated in favor of using resample_abs_pos_embed.
    """
...
@torch.no_grad()
def _load_weights(
    model: VisionTransformer, checkpoint_path: str, prefix: str = "", load_bfloat16: bool = False
) -> None:
    ...
    if model.attn_pool is not None:
        ...
        model.attn_pool.kv.weight.copy_(
            torch.cat([_n2p(w[f"{mha_prefix}{n}/kernel"], t=False).flatten(1).T for n in ("key", "value")])
        )
...
def _convert_beit3(state_dict: dict, model):
    ...
    rules = [
        ...
        (r"encoder\.", ""),
        (r"layers\.", "blocks."),
        (r"ffn_layernorm\.", "norm."),
        (r"ffn\.", "mlp."),
        (r"self_attn_layer_norm\.", "norm1."),
        (r"self_attn\.", "attn."),
    ...
    for k, v in tmp.items():
        ...
        if len(stash) == 3:  # Have q, k, v -> concatenate
            out[f"blocks.{blk}.attn.qkv.{kind}"] = torch.cat([stash["q"], stash["k"], stash["v"]], dim=0)
    ...
    for k, v in state_dict.items():
        if "patch_embed.proj.weight" in k:
            ...
            if len(v.shape) < 4:
                ...
                O, _I, H, W = model.patch_embed.proj.weight.shape
                v = v.reshape(O, -1, H, W)
...
default_cfgs = {
    ...
    "vit_base_patch32_224.sam_in1k": _cfg(
        url="https://storage.googleapis.com/vit_models/sam/ViT-B_32.npz", custom_load=True, hf_hub_id="timm/"
    ),
    "vit_base_patch16_224.sam_in1k": _cfg(
        url="https://storage.googleapis.com/vit_models/sam/ViT-B_16.npz", custom_load=True, hf_hub_id="timm/"
    ),
    ...
    "vit_base_patch32_clip_384.laion2b_ft_in12k_in1k": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, input_size=(3, 384, 384)
    ),
    "vit_base_patch32_clip_448.laion2b_ft_in12k_in1k": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, input_size=(3, 448, 448)
    ),
    ...
    "vit_large_patch14_clip_224.laion2b_ft_in12k_in1k": _cfg(
        hf_hub_id="timm/", mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD, crop_pct=1.0
    ),
    ...
    "vit_base_patch32_clip_224.laion2b_ft_in1k": _cfg(hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD),
    ...
    "vit_base_patch32_clip_224.openai_ft_in1k": _cfg(hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD),
    "vit_base_patch16_clip_224.openai_ft_in1k": _cfg(hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD),
    ...
    "vit_large_patch14_clip_224.laion2b_ft_in12k": _cfg(
        hf_hub_id="timm/", mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD, crop_pct=1.0, num_classes=11821
    ),
    "vit_huge_patch14_clip_224.laion2b_ft_in12k": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=11821
    ),
    ...
    "vit_base_patch16_clip_224.laion2b": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=512
    ),
    "vit_large_patch14_clip_224.laion2b": _cfg(
        hf_hub_id="timm/", mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD, crop_pct=1.0, num_classes=768
    ),
    "vit_huge_patch14_clip_224.laion2b": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=1024
    ),
    "vit_giant_patch14_clip_224.laion2b": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=1024
    ),
    "vit_gigantic_patch14_clip_224.laion2b": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=1280
    ),
    ...
    "vit_base_patch16_clip_224.laion400m_e32": _cfg(
        hf_hub_id="timm/", license="mit", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=512
    ),
    ...
    "vit_large_patch14_clip_224.laion400m_e32": _cfg(
        hf_hub_id="timm/", license="mit", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=768
    ),
    ...
    "vit_large_patch14_clip_224.datacompxl": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, num_classes=768
    ),
    ...
    "vit_base_patch32_siglip_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    ...
    "vit_base_patch16_siglip_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_base_patch16_siglip_256.webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_base_patch16_siglip_256.webli_i18n": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_base_patch16_siglip_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_base_patch16_siglip_384.webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_base_patch16_siglip_512.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_base_patch16_siglip_512.webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_large_patch16_siglip_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_large_patch16_siglip_256.webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_large_patch16_siglip_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_large_patch16_siglip_384.webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_large_patch16_siglip_512.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_so400m_patch14_siglip_224.v2_webli": _cfg(hf_hub_id="timm/", num_classes=0),
    "vit_so400m_patch14_siglip_224.webli": _cfg(hf_hub_id="timm/", num_classes=0),
    "vit_so400m_patch14_siglip_378.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 378, 378), num_classes=0),
    "vit_so400m_patch14_siglip_378.webli": _cfg(hf_hub_id="timm/", input_size=(3, 378, 378), num_classes=0),
    "vit_so400m_patch14_siglip_384.webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_so400m_patch16_siglip_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_so400m_patch16_siglip_256.webli_i18n": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_so400m_patch16_siglip_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_so400m_patch16_siglip_512.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_giantopt_patch16_siglip_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_giantopt_patch16_siglip_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_base_patch32_siglip_gap_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    ...
    "vit_base_patch16_siglip_gap_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_base_patch16_siglip_gap_256.webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_base_patch16_siglip_gap_256.webli_i18n": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_base_patch16_siglip_gap_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_base_patch16_siglip_gap_384.webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_base_patch16_siglip_gap_512.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_base_patch16_siglip_gap_512.webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_large_patch16_siglip_gap_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_large_patch16_siglip_gap_256.webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_large_patch16_siglip_gap_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_large_patch16_siglip_gap_384.webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_large_patch16_siglip_gap_512.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    ...
    #     custom_load='hf',
    #     num_classes=0),
    "vit_so400m_patch14_siglip_gap_378.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 378, 378), num_classes=0),
    ...
    #     num_classes=0),
    "vit_so400m_patch16_siglip_gap_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_so400m_patch16_siglip_gap_256.webli_i18n": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_so400m_patch16_siglip_gap_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    "vit_so400m_patch16_siglip_gap_512.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 512, 512), num_classes=0),
    "vit_giantopt_patch16_siglip_gap_256.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), num_classes=0),
    "vit_giantopt_patch16_siglip_gap_384.v2_webli": _cfg(hf_hub_id="timm/", input_size=(3, 384, 384), num_classes=0),
    ...
    "vit_xsmall_patch16_clip_224.tinyclip_yfcc15m": _cfg(
        hf_hub_id="timm/", license="mit", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=512
    ),
    ...
    "vit_little_patch16_reg4_gap_256.sbb_in1k": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), crop_pct=0.95),
    ...
    "vit_medium_patch16_reg4_gap_256.sbb_in1k": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), crop_pct=0.95),
    ...
    "vit_so150m2_patch16_reg1_gap_256.sbb_e200_in12k_ft_in1k": _cfg(
        hf_hub_id="timm/", input_size=(3, 256, 256), crop_pct=1.0
    ),
    "vit_so150m2_patch16_reg1_gap_256.sbb_e200_in12k": _cfg(
        hf_hub_id="timm/", num_classes=11821, input_size=(3, 256, 256), crop_pct=1.0
    ),
    "vit_so150m2_patch16_reg1_gap_384.sbb_e200_in12k_ft_in1k": _cfg(
        hf_hub_id="timm/", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "vit_so150m2_patch16_reg1_gap_448.sbb_e200_in12k_ft_in1k": _cfg(
        hf_hub_id="timm/", input_size=(3, 448, 448), crop_pct=1.0, crop_mode="squash"
    ),
    ...
    "aimv2_large_patch14_224.apple_pt": _cfg(
        hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, license="apple-ascl", crop_pct=1.0, num_classes=0
    ),
    ...
    "beit3_base_patch16_224.in22k_ft_in1k": _cfg(
        hf_hub_id="timm/", mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD, crop_pct=1.0
    ),
...
def _create_vision_transformer(
    ...
    use_naflex: bool | None = None,
    **kwargs,
) -> VisionTransformer | NaFlexVit:
...
def vit_tiny_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Tiny (Vit-Ti/16)."""
    model_args = {"patch_size": 16, "embed_dim": 192, "depth": 12, "num_heads": 3}
...
def vit_small_patch8_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Small (ViT-S/8)."""
    model_args = {"patch_size": 8, "embed_dim": 384, "depth": 12, "num_heads": 6}
...
def vit_base_patch32_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/32) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned from
    in21k, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 32, "embed_dim": 768, "depth": 12, "num_heads": 12}
...
def vit_base_patch32_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base model (ViT-B/32) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned
    from in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 32, "embed_dim": 768, "depth": 12, "num_heads": 12}
...
def vit_base_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned from
    in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12}
...
def vit_base_patch16_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned
    from in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12}
...
def vit_base_patch8_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/8) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned from
    in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 8, "embed_dim": 768, "depth": 12, "num_heads": 12}
...
def vit_large_patch32_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 32, "embed_dim": 1024, "depth": 24, "num_heads": 16}
...
def vit_large_patch32_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Large model (ViT-L/32) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned
    from in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 32, "embed_dim": 1024, "depth": 24, "num_heads": 16}
...
def vit_large_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929). ImageNet-1k weights fine-tuned
    from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_args = {"patch_size": 16, "embed_dim": 1024, "depth": 24, "num_heads": 16}
...
def vit_large_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 14, "embed_dim": 1024, "depth": 24, "num_heads": 16}
...
def vit_huge_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 14, "embed_dim": 1280, "depth": 32, "num_heads": 16}
...
def vit_giant_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 14, "embed_dim": 1408, "mlp_ratio": 48 / 11, "depth": 40, "num_heads": 16}
...
def vit_gigantic_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 14, "embed_dim": 1664, "mlp_ratio": 64 / 13, "depth": 48, "num_heads": 16}
...
def vit_base_patch16_224_miil(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929). Weights taken from:
    https://github.com/Alibaba-MIIL/ImageNet21K.
    """
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12, "qkv_bias": False}
...
def vit_huge_patch14_gap_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_huge_patch14_gap_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_huge_patch16_gap_448(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_huge_patch16_gap_448", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_giant_patch16_gap_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_giant_patch16_gap_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch32_clip_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch32_clip_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_huge_patch14_clip_378(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_huge_patch14_clip_378", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_gigantic_patch14_clip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-bigG model (ViT-G/14) from `Scaling Vision Transformers` - https://arxiv.org/abs/2106.04560 Pretrained
    weights from CLIP image tower.
    """
    model_args = {
        "patch_size": 14,
        "embed_dim": 1664,
...
def vit_base_patch32_plus_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/32+)."""
    model_args = {"patch_size": 32, "embed_dim": 896, "depth": 12, "num_heads": 14, "init_values": 1e-5}
...
def vit_base_patch16_plus_240(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base (ViT-B/16+)."""
    model_args = {"patch_size": 16, "embed_dim": 896, "depth": 12, "num_heads": 14, "init_values": 1e-5}
...
def vit_small_patch16_36x1_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base w/ LayerScale + 36 x 1 (36 block serial) config. Experimental, may remove. Based on `Three things
    everyone should know about Vision Transformers` - https://arxiv.org/abs/2203.09795 Paper focuses on 24x2 + 48x1
    for 'Small' width but those are extremely slow.
    """
    model_args = {"patch_size": 16, "embed_dim": 384, "depth": 36, "num_heads": 6, "init_values": 1e-5}
    model = _create_vision_transformer(
...
def vit_small_patch16_18x2_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Small w/ LayerScale + 18 x 2 (36 block parallel) config. Experimental, may remove. Based on `Three things
    everyone should know about Vision Transformers` - https://arxiv.org/abs/2203.09795 Paper focuses on 24x2 + 48x1
    for 'Small' width but those are extremely slow.
    """
    model_args = {
...
def vit_base_patch16_18x2_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-Base w/ LayerScale + 18 x 2 (36 block parallel) config. Experimental, may remove. Based on `Three things
    everyone should know about Vision Transformers` - https://arxiv.org/abs/2203.09795.
    """
    model_args = {
        "patch_size": 16,
        "embed_dim": 768,
...
def eva_large_patch14_196(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = {"patch_size": 14, "embed_dim": 1024, "depth": 24, "num_heads": 16, "global_pool": "avg"}
...
def flexivit_small(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """FlexiViT-Small."""
    model_args = {"patch_size": 16, "embed_dim": 384, "depth": 12, "num_heads": 6, "no_embed_class": True}
...
def flexivit_base(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """FlexiViT-Base."""
    model_args = {"patch_size": 16, "embed_dim": 768, "depth": 12, "num_heads": 12, "no_embed_class": True}
...
def flexivit_large(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """FlexiViT-Large."""
    model_args = {"patch_size": 16, "embed_dim": 1024, "depth": 24, "num_heads": 16, "no_embed_class": True}
...
def vit_small_patch14_dinov2(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-S/14 for DINOv2."""
    model_args = {"patch_size": 14, "embed_dim": 384, "depth": 12, "num_heads": 6, "init_values": 1e-5}
...
def vit_base_patch14_dinov2(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-B/14 for DINOv2."""
    model_args = {"patch_size": 14, "embed_dim": 768, "depth": 12, "num_heads": 12, "init_values": 1e-5}
...
def vit_large_patch14_dinov2(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-L/14 for DINOv2."""
    model_args = {"patch_size": 14, "embed_dim": 1024, "depth": 24, "num_heads": 16, "init_values": 1e-5}
...
def vit_dpwee_patch16_reg1_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = {
        ...
        "reg_tokens": 1,
        "global_pool": "avg",
        "block_fn": DiffParallelScalingBlock,
    }
    model = _create_vision_transformer(
...
def aimv2_large_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_large_patch14_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_huge_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_huge_patch14_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_1b_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_1b_patch14_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_3b_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_3b_patch14_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_large_patch14_336(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_large_patch14_336", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_huge_patch14_336(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_huge_patch14_336", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_1b_patch14_336(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_1b_patch14_336", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_3b_patch14_336(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_3b_patch14_336", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_large_patch14_448(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_large_patch14_448", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_huge_patch14_448(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_huge_patch14_448", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_1b_patch14_448(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_1b_patch14_448", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def aimv2_3b_patch14_448(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("aimv2_3b_patch14_448", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def beit3_base_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """BEiT3 Base model (ViT-Base size) with patch size 16x16. Remapped to VisionTransformer with scale_norm=True.
    """
    model_args = {
        "patch_size": 16,
        "embed_dim": 768,
...
def beit3_large_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """BEiT3 Large model (ViT-Large size) with patch size 16x16. Remapped to VisionTransformer with scale_norm=True.
    """
    model_args = {
        "patch_size": 16,
        "embed_dim": 1024,
...
def beit3_giant_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """BEiT3 Giant model with patch size 14x14. Remapped to VisionTransformer with scale_norm=True.
    """
    model_args = {
        "patch_size": 14,
        "embed_dim": 1408,
...
def beit3_giant_patch14_336(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """BEiT3 Giant model with patch size 14x14 and image size 336x336. Remapped to VisionTransformer with
    scale_norm=True.
    """
    model_args = {
        "img_size": 336,
