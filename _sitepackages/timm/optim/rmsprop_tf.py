...
class RMSpropTF(Optimizer):
    ...
    NOTE: This is a direct cut-and-paste of PyTorch RMSprop with eps applied before sqrt and a few other modifications
                ...
                if group["weight_decay"] != 0:
                    if group["decoupled_decay"]:
                        if group["corrected_weight_decay"]:
                            ...
                            wd_scale = group["lr"]
                        p.mul_(1.0 - wd_scale * group["weight_decay"])
                    else:
