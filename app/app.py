...
class ObjectDetector:
    ...
    def detect_image(self, image_path, conf_threshold=0.5, iou_threshold=0.45):
        ...
        try:
            ...
            if self.model_type == "yolov8":
                ...
                class_counts_db = {name: (v[0], v[1], round(v[2] / v[1], 4)) for name, v in class_counts.items()}
                # 保留旧格式供前端使用
    ...
    def detect_video(self, video_path, conf_threshold=0.5, iou_threshold=0.45):
        ...
        try:
            ...
            class_counts_db = {name: (v[0], v[1], round(v[2] / v[1], 4)) for name, v in class_counts_acc.items()}
