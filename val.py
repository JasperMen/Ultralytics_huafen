...
if __name__ == "__main__":
    # 选择训练好的权重路径
    # model_path = 'runs/detect/train/exp3/weights/best_fp32.pt'
    model_path = "/home/user/Men/Ultralytics_huafen/runs/detect/downsampe_imporove/yolo11-DRFD/weights/best_fp32.pt"
    # 设置用于计算指标的图像尺寸
    imgsz = 640

    model = YOLO(model_path)
    result = model.val(
        data="huafen_data6.yaml",
    ...
    if model.task == "detect" or model.task == "obb":
        yolo_metrics_table.field_names = [
            "Class Name",
            "Box (Precision",
            "Recall",
            "F1-Score",
