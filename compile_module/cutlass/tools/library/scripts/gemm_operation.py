...
class GemmOperation:
    ...
    def procedural_name(self):
        ...
        max([self.A.alignment, self.B.alignment, self.C.alignment])
...
"""
    ...
    def emit(self, operation):
        ...
        warp_shape = [
            operation.tile_description.threadblock_shape[idx] // operation.tile_description.warp_count[idx]
            for idx in range(3)
        ]
...
"""
    ...
    def emit(self, operation):
        ...
        if (
            operation.A.layout in transpose_layouts
...
class EmitGemmConfigurationLibrary:
    def __init__(self, operation_path, configuration_name):
        ...
        self.configuration_path = os.path.join(operation_path, f"{configuration_name}.cu").replace("\\", "/")
...
"""
        ...
        self.instance_wrappers.append(
            SubstituteTemplate(
                self.instance_template[operation.gemm_kind],
                {
                    ...
                    if operation.tile_description.math_instruction.opcode_class == OpcodeClass.WmmaTensorOp
                    else "",
    ...
    def __exit__(self, exception_type, exception_value, traceback):
        ...
        self.configuration_file.write(
            SubstituteTemplate(self.initialize_function_template, {"configuration_name": self.configuration_name})
        )
