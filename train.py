...
if __name__ == '__main__':
    yaml_path = '/home/user/Men/Ultralytics_huafen/ultralytics/cfg/models/improve/model2025/yolo11/yolo11n-DySampleFusion-MLLAGNorm.yaml'

    # 初始化 YOLO 模型，从 yaml 配置文件构建网络结构
    model = YOLO(yaml_path)
    # model.load('yolo26n.pt') # 加载预训练权重，一般都不建议加载
    model.train(data='/home/user/Men/Ultralytics_huafen/huafen_data6.yaml', # 数据集配置文件路径
                ...
                project='/home/user/Men/Ultralytics_huafen/runs/model2025', # 训练结果保存的项目目录
                name='yolo11n-DySampleFusion-MLLAGNorm', # 本次实验的名称，（若已存在则自动创建 exp2, exp3...）
                ...
                cls_loss='slide', # 分类损失类型可选：bce, slide, ema_slide, focal, varifocal, qualityfocal
